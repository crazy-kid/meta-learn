...
train_dataset_x = np.load(meta_data_dir + "train_dataset_x_400.npy")
train_dataset_y = np.load(meta_data_dir + "train_dataset_y_400.npy")
...
test_dataset_x = np.load(meta_data_dir + "test_dataset_x_400.npy")
test_dataset_y = np.load(meta_data_dir + "test_dataset_y_400.npy")
...
optimizer = torch.optim.AdamW(
    [{"params": nnprior_mean.parameters(), "lr": 1e-2}, 
...
forward_prior = ForwardPrior(
    ...
    dataset=train_dataset_Sy, device=device
    )
