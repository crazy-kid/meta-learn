...
# -*- coding: utf-8 -*-
"""
Created on Fri Aug 12 09:55:50 2022
...
def generate_model_parameter(domain, branch=1):
    def random_numbers():
        ...
        a14 = np.random.uniform(20, 30)
        a24 = np.random.uniform(20, 30)
        a34 = np.random.uniform(20, 30)
        a16 = np.random.uniform(20, 30)
        a26 = np.random.uniform(20, 30)
        a36 = np.random.uniform(20, 30)
        a15 = np.random.uniform(0.25, 0.35)
        a25 = np.random.uniform(0.65, 0.75)
        a35 = np.random.uniform(0.45, 0.55)
        a17 = np.random.uniform(0.25, 0.35)
        a27 = np.random.uniform(0.25, 0.35)
        a37 = np.random.uniform(0.65, 0.75)
    ...
    if branch == 1:
        f_expre = f_expre01 + "+" + f_expre02 + "+" + f_expre03
    else:
        f_expre = "-" + f_expre01 + "-" + f_expre02 + "-" + f_expre03
