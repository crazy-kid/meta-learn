...
for idx_ in range(20):
    ...
    err_L2 = relative_error(mean_learn_prior_1, u_meta_fun_test1, domain, err_type="L2") 
    err_Max = relative_error(mean_learn_prior_1, u_meta_fun_test1, domain, err_type="Max")
    error_posterior_mean.append([err_L2, err_Max])
    
    err_L2 = relative_error(mean_unlearn_1, u_meta_fun_test1, domain, err_type="L2")
    err_Max = relative_error(mean_unlearn_1, u_meta_fun_test1, domain, err_type="Max")
    error_unlearned.append([err_L2, err_Max])
    ...
    err_L2 = relative_error(mean_learn_prior_2, u_meta_fun_test2, domain, err_type="L2") 
    err_Max = relative_error(mean_learn_prior_2, u_meta_fun_test2, domain, err_type="Max") 
    error_posterior_mean.append([err_L2, err_Max])
    
    err_L2 = relative_error(mean_unlearn_2, u_meta_fun_test2, domain, err_type="L2")
    err_Max = relative_error(mean_unlearn_2, u_meta_fun_test2, domain, err_type="Max")
    error_unlearned.append([err_L2, err_Max])
    
error_unlearned_L2 = np.array(error_unlearned)[:,0]
error_unlearned_Max = np.array(error_unlearned)[:,1]
error_posterior_mean_L2 = np.array(error_posterior_mean)[:,0]
error_posterior_mean_Max = np.array(error_posterior_mean)[:,1]
print("unlearned error L2: %.6f" % (np.mean(error_unlearned_L2)))
print("posterior error L2: %.6f" % (np.mean(error_posterior_mean_L2)))
print("unlearned error Max: %.6f" % (np.mean(error_unlearned_Max)))
print("posterior error Max: %.6f" % (np.mean(error_posterior_mean_Max)))
